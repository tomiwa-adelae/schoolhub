				...
				<div className="col-span-3 lg:col-span-2">
					...
					<div className="grid grid-cols-2 gap-4 mt-4">
						...
						<div className="bg-blue-400 text-white rounded-md flex flex-col items-center justify-center gap-4 text-center p-4 ">
							<Plus />
							<h3 className="font-bold text-sm">Add course</h3>
						</div>
					</div>
				</div>
			</div>
			<div className="grid grid-cols-1 lg:grid-cols-5 gap-4 my-10 ">
				<div className="col-span-2">
					<div className="border-2 border-dashed rounded-md p-4 border-gray-400">
						...
						<div className="text-center mt-4">
							<Button size={"sm"} asChild variant={"ghost"}>
								<Link href="/courses">Show all colleagues</Link>
							</Button>
						</div>
					</div>
				</div>
				<div className="col-span-2 lg:col-span-3">
					<div className="border-2 border-dashed rounded-md p-4 border-gray-400">
						<h3 className="font-bold text-lg mb-4">My lecturers</h3>
						<div className="grid grid-cols-1 gap-4">
							<Lecturer />
							<Lecturer />
							<Lecturer />
						...
						<div className="text-center mt-4">
							<Button size={"sm"} asChild variant={"ghost"}>
								<Link href="/courses">Show all lecturers</Link>
							</Button>
						</div>
					</div>
				</div>
